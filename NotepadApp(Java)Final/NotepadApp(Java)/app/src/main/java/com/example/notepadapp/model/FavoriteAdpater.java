...
public class FavoriteAdpater extends RecyclerView.Adapter<FavoriteAdpater.ViewHolder> {
    ...
    public FavoriteAdpater(Context context,List<FavoriteModel> mData) {
    ...
    @NonNull
    @Override
    public FavoriteAdpater.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.rowfavoritedesign, parent, false);
        return new FavoriteAdpater.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FavoriteAdpater.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
